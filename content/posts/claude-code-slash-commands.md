...
これまでの記事で、[Claude Code 入門](/posts/claude-code-getting-started/) と [CLAUDE.md の書き方](/posts/how-to-write-claude-md/) を紹介してきました。今回はシリーズ最終回、セッション中の操作を一段ラクにするスラッシュコマンドの話です。
